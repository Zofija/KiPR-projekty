...
typedef struct {
  ...
  boolean_T DataStoreRead2_j;          /* '<S16>/Data Store Read2' */
  boolean_T DataStoreRead2_f;          /* '<S17>/Data Store Read2' */
  boolean_T Compare_f;                 /* '<S45>/Compare' */
  boolean_T Compare_ml;                /* '<S46>/Compare' */
  ...
  boolean_T DataStoreRead2_i;          /* '<S8>/Data Store Read2' */
  boolean_T SFunction;                 /* '<S33>/S-Function' */
  ...
  boolean_T SFunction_p;               /* '<S38>/S-Function' */
  boolean_T LogicalOperator3_d;        /* '<S9>/Logical Operator3' */
  boolean_T Memory_e;                  /* '<S40>/Memory' */
  boolean_T Logic_g[2];                /* '<S40>/Logic' */
  boolean_T Compare_g;                 /* '<S41>/Compare' */
  boolean_T Compare_d;                 /* '<S42>/Compare' */
  boolean_T LogicalOperator1_f;        /* '<S12>/Logical Operator1' */
  boolean_T Compare_n;                 /* '<S43>/Compare' */
  ...
  boolean_T DataStoreRead3_m;          /* '<S16>/Data Store Read3' */
...
typedef struct {
  ...
  real_T Memory3_PreviousInput;        /* '<S16>/Memory3' */
  ...
  boolean_T Memory_PreviousInput_d;    /* '<S40>/Memory' */
 ...
 * '<S30>'  : 'SCARA_215/RTI Data/RTI Data Store'
 * '<S31>'  : 'SCARA_215/RTI Data/RTI Data Store/RTI Data Store'
 * '<S32>'  : 'SCARA_215/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 * '<S33>'  : 'SCARA_215/bazowanie_1/DS1104BIT_IN_C0'
 * '<S34>'  : 'SCARA_215/bazowanie_1/DS1104ENC_SET_POS_C1'
 * '<S35>'  : 'SCARA_215/bazowanie_1/Detect Fall Nonpositive'
 * '<S36>'  : 'SCARA_215/bazowanie_1/S-R Flip-Flop'
 * '<S37>'  : 'SCARA_215/bazowanie_1/Detect Fall Nonpositive/Nonpositive'
 * '<S38>'  : 'SCARA_215/bazowanie_2 /DS1104BIT_IN_C1'
 * '<S39>'  : 'SCARA_215/bazowanie_2 /DS1104ENC_SET_POS_C2'
 * '<S40>'  : 'SCARA_215/bazowanie_2 /S-R Flip-Flop1'
 * '<S41>'  : 'SCARA_215/predkosc_zadana_1/Compare To Constant'
 * '<S42>'  : 'SCARA_215/predkosc_zadana_1/Compare To Constant1'
 * '<S43>'  : 'SCARA_215/predkosc_zadana_2/Compare To Constant'
 * '<S44>'  : 'SCARA_215/predkosc_zadana_2/Compare To Constant1'
 * '<S45>'  : 'SCARA_215/wspolczynniki/Compare To Zero'
 * '<S46>'  : 'SCARA_215/wspolczynniki/Compare To Zero1'
 */

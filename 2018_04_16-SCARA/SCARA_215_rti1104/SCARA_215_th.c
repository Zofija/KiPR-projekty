/************************ dSPACE target specific file *************************
   ...
   Include file .\SCARA_215_rti1104\SCARA_215_th.c :

   Task Configuration file for model : SCARA_215

   RTI1104 7.4 (02-May-2015)/2.10
   16-Apr-2018 09:25:08
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\SCARA_215_rti1104\SCARA_215_th.c is for ST).
# endif

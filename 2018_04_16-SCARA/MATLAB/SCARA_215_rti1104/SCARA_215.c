...
static void SCARA_215_output(void)
{
  ...
  SCARA_215_B.DataStoreRead2_i = SCARA_215_DW.wyzwalanie_ON;

  /* Switch: '<S5>/Switch7' */
  if (SCARA_215_B.DataStoreRead2_i) {
    /* DataStoreRead: '<S31>/Data Store Read3' */
    SCARA_215_B.DataStoreRead3_m = SCARA_215_DW.wyzwolenie;

    /* Switch: '<S31>/Switch9' */
    if (SCARA_215_B.DataStoreRead3_m) {
      SCARA_215_B.Switch9_a = SCARA_215_B.DataStoreRead6;
    } else {
      SCARA_215_B.Switch9_a = SCARA_215_B.Memory3;
    }

    /* End of Switch: '<S31>/Switch9' */
    SCARA_215_B.Switch7 = SCARA_215_B.Switch9_a;
  } else {
    SCARA_215_B.Switch7 = SCARA_215_B.DataStoreRead6;
  }
  ...
  /* Memory: '<S30>/Memory3' */
  SCARA_215_B.Memory3_c = SCARA_215_DW.Memory3_PreviousInput_a;
  ...
  if (SCARA_215_B.DataStoreRead2_j) {
    ...
    SCARA_215_B.DataStoreRead3_j = SCARA_215_DW.wyzwolenie;

    /* Switch: '<S30>/Switch9' */
    if (SCARA_215_B.DataStoreRead3_j) {
      SCARA_215_B.Switch9_m = SCARA_215_B.DataStoreRead5;
    } else {
      SCARA_215_B.Switch9_m = SCARA_215_B.Memory3_c;
    }

    /* End of Switch: '<S30>/Switch9' */
    SCARA_215_B.Switch8 = SCARA_215_B.Switch9_m;
  } else {
    SCARA_215_B.Switch8 = SCARA_215_B.DataStoreRead5;
  }

  /* End of Switch: '<S5>/Switch8' */

  /* Product: '<S28>/Product2' */
  SCARA_215_B.Product2 = SCARA_215_B.Switch8 * SCARA_215_B.Switch8;

  /* Product: '<S29>/Product2' */
  SCARA_215_B.Product2_b = SCARA_215_B.Switch7 * SCARA_215_B.Switch7;
  ...
  if (SCARA_215_B.and_ogr) {
    SCARA_215_B.Switch1 = SCARA_215_B.Switch7;
  } else {
  ...
  /* Memory: '<S16>/Memory3' */
  SCARA_215_B.Memory3_h = SCARA_215_DW.Memory3_PreviousInput_h;

  /* DataStoreRead: '<S16>/Data Store Read2' */
  SCARA_215_B.DataStoreRead2_j3 = SCARA_215_DW.wyzwalanie_ON;

  /* Switch: '<Root>/Switch8' */
  if (SCARA_215_B.DataStoreRead2_j3) {
    ...
    SCARA_215_B.DataStoreRead3_mz = SCARA_215_DW.wyzwolenie;

    /* Logic: '<S16>/Logical Operator1' */
    SCARA_215_B.LogicalOperator1_n = (SCARA_215_B.DataStoreRead3_mz ||
    ...
    if (SCARA_215_B.LogicalOperator1_n) {
      ...
      SCARA_215_B.Switch9_is = SCARA_215_B.Memory3_h;
    }

    /* End of Switch: '<S16>/Switch9' */
    SCARA_215_B.Switch8_b = SCARA_215_B.Switch9_is;
  } else {
    SCARA_215_B.Switch8_b = SCARA_215_B.Switch9;
  }

  /* End of Switch: '<Root>/Switch8' */

  /* Switch: '<S14>/Switch' */
  if (SCARA_215_B.Switch8_b > SCARA_215_P.Switch_Threshold) {
    SCARA_215_B.Switch_i = SCARA_215_B.Memory1;
  } else {
    SCARA_215_B.Switch_i = SCARA_215_B.Switch8_b;
  }
  ...
  SCARA_215_B.DataStoreRead2_i4 = SCARA_215_DW.bazowanie1;

  /* S-Function (rti_commonblock): '<S35>/S-Function' */
  /* This comment workarounds a code generation problem */
  ...
  zcEvent = SCARA_215_B.DataStoreRead2_i4;
  rowIdx = zcEvent;
  ...
  /* S-Function (rti_commonblock): '<S40>/S-Function' */
  /* This comment workarounds a code generation problem */
  ...
  if (SCARA_215_B.Logic_g[0]) {
    SCARA_215_B.Switch7_b = SCARA_215_P.Constant3_Value;
  } else {
    /* DataStoreRead: '<S9>/Data Store Read5' */
    SCARA_215_B.DataStoreRead5_b = SCARA_215_DW.WZ2;
    SCARA_215_B.Switch7_b = SCARA_215_B.DataStoreRead5_b;
  }

  /* End of Switch: '<S9>/Switch7' */

  /* DataStoreWrite: '<S9>/Data Store Write3' */
  SCARA_215_DW.WZ2 = SCARA_215_B.Switch7_b;
...
static void SCARA_215_update(void)
{
  ...
  SCARA_215_DW.Memory3_PreviousInput_a = SCARA_215_B.Switch;
  ...
  SCARA_215_DW.Memory3_PreviousInput_h = SCARA_215_B.Switch1_b;
...
static void SCARA_215_initialize(void)
{
  ...
  SCARA_215_DW.Memory3_PreviousInput_a = SCARA_215_P.Memory3_X0_a;
  ...
  SCARA_215_DW.Memory3_PreviousInput_h = SCARA_215_P.Memory3_X0_g;
...
RT_MODEL_SCARA_215_T *SCARA_215(void)
{
  ...
  SCARA_215_M->Sizes.numBlocks = (259);/* Number of blocks */
  SCARA_215_M->Sizes.numBlockIO = (178);/* Number of block outputs */
  SCARA_215_M->Sizes.numBlockPrms = (114);/* Sum of parameter "widths" */
  return SCARA_215_M;
}

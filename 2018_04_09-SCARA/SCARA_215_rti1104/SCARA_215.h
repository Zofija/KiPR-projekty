...
typedef struct {
  ...
  real_T Memory3;                      /* '<S15>/Memory3' */
  real_T Switch8;                      /* '<Root>/Switch8' */
  ...
  real_T Memory1_k;                    /* '<S14>/Memory1' */
  real_T DataStoreRead1;               /* '<Root>/Data Store Read1' */
  real_T Memory3_n;                    /* '<S16>/Memory3' */
  real_T Switch1_i;                    /* '<Root>/Switch1' */
  real_T Switch_i;                     /* '<S14>/Switch' */
  real_T Switch1_g;                    /* '<S14>/Switch1' */
  real_T Sum1;                         /* '<Root>/Sum1' */
  real_T Abs1;                         /* '<S17>/Abs1' */
  real_T MinMax;                       /* '<S17>/MinMax' */
  real_T Switch2;                      /* '<S17>/Switch2' */
  real_T Switch3;                      /* '<S17>/Switch3' */
  real_T Switch6;                      /* '<S7>/Switch6' */
  real_T Switch7;                      /* '<S8>/Switch7' */
  real_T DataStoreRead3;               /* '<S11>/Data Store Read3' */
  real_T regP3;                        /* '<S11>/reg P3' */
  real_T Memory3_m;                    /* '<S11>/Memory3' */
  real_T Switch7_j;                    /* '<S11>/Switch7' */
  real_T regP1;                        /* '<Root>/reg P1' */
  real_T v1;                           /* '<Root>/Saturation1' */
  real_T Switch6_i;                    /* '<Root>/Switch6' */
  real_T Switch4;                      /* '<Root>/Switch4' */
  real_T RateLimiter1;                 /* '<Root>/Rate Limiter1' */
  real_T Gain2;                        /* '<Root>/Gain2' */
  real_T DataStoreRead3_h;             /* '<S12>/Data Store Read3' */
  real_T regP3_g;                      /* '<S12>/reg P3' */
  real_T Memory3_mw;                   /* '<S12>/Memory3' */
  real_T Switch7_f;                    /* '<S12>/Switch7' */
  real_T regP2;                        /* '<Root>/reg P2' */
  real_T v1_g;                         /* '<Root>/Saturation2' */
  real_T Switch7_l;                    /* '<Root>/Switch7' */
  real_T Switch5;                      /* '<Root>/Switch5' */
  real_T RateLimiter2;                 /* '<Root>/Rate Limiter2' */
  real_T Gain4;                        /* '<Root>/Gain4' */
  real_T SFunction2;                   /* '<S3>/S-Function2' */
  real_T SFunction2_c;                 /* '<S6>/S-Function2' */
  real_T Divide;                       /* '<S17>/Divide' */
  real_T Saturation3;                  /* '<S17>/Saturation3' */
  real_T Divide1;                      /* '<S17>/Divide1' */
  real_T Saturation4;                  /* '<S17>/Saturation4' */
  real_T DataStoreRead5;               /* '<S8>/Data Store Read5' */
  real_T DataStoreRead4;               /* '<S7>/Data Store Read4' */
  real_T Switch9;                      /* '<S16>/Switch9' */
  real_T Switch3_g;                    /* '<Root>/Switch3' */
  real_T DataStoreRead3_h3;            /* '<S9>/Data Store Read3' */
  real_T Product;                      /* '<S9>/Product' */
  real_T Switch2_a;                    /* '<Root>/Switch2' */
  real_T DataStoreRead3_b;             /* '<S10>/Data Store Read3' */
  real_T Product_l;                    /* '<S10>/Product' */
  real_T Product_d;                    /* '<S11>/Product' */
  real_T Product_i;                    /* '<S12>/Product' */
  real_T Switch9_i;                    /* '<S15>/Switch9' */
  boolean_T DataStoreRead2;            /* '<S15>/Data Store Read2' */
  boolean_T DataStoreRead2_f;          /* '<S16>/Data Store Read2' */
  boolean_T Compare;                   /* '<S33>/Compare' */
  boolean_T Compare_m;                 /* '<S34>/Compare' */
  boolean_T DataStoreRead2_i;          /* '<S7>/Data Store Read2' */
  boolean_T SFunction;                 /* '<S21>/S-Function' */
  boolean_T LogicalOperator1;          /* '<S7>/Logical Operator1' */
  boolean_T Memory;                    /* '<S24>/Memory' */
  boolean_T Logic[2];                  /* '<S24>/Logic' */
  boolean_T Compare_e;                 /* '<S25>/Compare' */
  boolean_T Uk1;                       /* '<S23>/Delay Input1' */
  boolean_T FixPtRelationalOperator;   /* '<S23>/FixPt Relational Operator' */
  boolean_T DataStoreRead3_p;          /* '<S8>/Data Store Read3' */
  boolean_T SFunction_p;               /* '<S26>/S-Function' */
  boolean_T LogicalOperator3;          /* '<S8>/Logical Operator3' */
  boolean_T Memory_e;                  /* '<S28>/Memory' */
  boolean_T Logic_g[2];                /* '<S28>/Logic' */
  boolean_T Compare_g;                 /* '<S29>/Compare' */
  boolean_T Compare_d;                 /* '<S30>/Compare' */
  boolean_T LogicalOperator1_f;        /* '<S11>/Logical Operator1' */
  boolean_T DataStoreRead2_b;          /* '<S11>/Data Store Read2' */
  boolean_T Compare_n;                 /* '<S31>/Compare' */
  boolean_T Compare_p;                 /* '<S32>/Compare' */
  boolean_T LogicalOperator1_e;        /* '<S12>/Logical Operator1' */
  boolean_T DataStoreRead2_n;          /* '<S12>/Data Store Read2' */
  boolean_T DataStoreRead3_k;          /* '<S16>/Data Store Read3' */
  boolean_T DataStoreRead2_m;          /* '<S9>/Data Store Read2' */
  boolean_T DataStoreRead2_mw;         /* '<S10>/Data Store Read2' */
  boolean_T DataStoreRead3_m;          /* '<S15>/Data Store Read3' */
} B_SCARA_215_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T Memory1_PreviousInput;        /* '<S13>/Memory1' */
  real_T Memory3_PreviousInput;        /* '<S15>/Memory3' */
  real_T Memory1_PreviousInput_j;      /* '<S14>/Memory1' */
  real_T Memory3_PreviousInput_l;      /* '<S16>/Memory3' */
  real_T Memory3_PreviousInput_f;      /* '<S11>/Memory3' */
  real_T PrevY;                        /* '<Root>/Rate Limiter1' */
  real_T Memory3_PreviousInput_b;      /* '<S12>/Memory3' */
  ...
  boolean_T Memory_PreviousInput_d;    /* '<S28>/Memory' */
  boolean_T V_koordynacja_ON;          /* '<Root>/Data Store Memory10' */
  boolean_T bazowanie1;                /* '<Root>/Data Store Memory2' */
  boolean_T bazowanie2;                /* '<Root>/Data Store Memory3' */
  boolean_T V_zadana_ON;               /* '<Root>/Data Store Memory4' */
...
typedef struct {
  ZCSigState DS1104ENC_SET_POS_C2_Trig_ZCE;/* '<S8>/DS1104ENC_SET_POS_C2' */
...
struct P_SCARA_215_T_ {
  ...
  boolean_T Logic_table_o[16];         /* Computed Parameter: Logic_table_o
                                        ...
                                        */
  boolean_T DataStoreMemory10_InitialValue;/* Expression: false
 ...
 * '<S5>'   : 'SCARA_215/RTI Data'
 * '<S6>'   : 'SCARA_215/_DS1104ENC_POS_C1'
 * '<S7>'   : 'SCARA_215/bazowanie_1'
 * '<S8>'   : 'SCARA_215/bazowanie_2 '
 * '<S9>'   : 'SCARA_215/koordynacja_predkosci_1'
 * '<S10>'  : 'SCARA_215/koordynacja_predkosci_2'
 * '<S11>'  : 'SCARA_215/predkosc_zadana_1'
 * '<S12>'  : 'SCARA_215/predkosc_zadana_2'
 * '<S13>'  : 'SCARA_215/sprawdzenie_poprawnosci_WZ1'
 * '<S14>'  : 'SCARA_215/sprawdzenie_poprawnosci_WZ2'
 * '<S15>'  : 'SCARA_215/tryb_wyzwalania_1'
 * '<S16>'  : 'SCARA_215/tryb_wyzwalania_2'
 * '<S17>'  : 'SCARA_215/wspolczynniki'
 * '<S18>'  : 'SCARA_215/RTI Data/RTI Data Store'
 * '<S19>'  : 'SCARA_215/RTI Data/RTI Data Store/RTI Data Store'
 * '<S20>'  : 'SCARA_215/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 * '<S21>'  : 'SCARA_215/bazowanie_1/DS1104BIT_IN_C0'
 * '<S22>'  : 'SCARA_215/bazowanie_1/DS1104ENC_SET_POS_C1'
 * '<S23>'  : 'SCARA_215/bazowanie_1/Detect Fall Nonpositive'
 * '<S24>'  : 'SCARA_215/bazowanie_1/S-R Flip-Flop'
 * '<S25>'  : 'SCARA_215/bazowanie_1/Detect Fall Nonpositive/Nonpositive'
 * '<S26>'  : 'SCARA_215/bazowanie_2 /DS1104BIT_IN_C1'
 * '<S27>'  : 'SCARA_215/bazowanie_2 /DS1104ENC_SET_POS_C2'
 * '<S28>'  : 'SCARA_215/bazowanie_2 /S-R Flip-Flop1'
 * '<S29>'  : 'SCARA_215/predkosc_zadana_1/Compare To Constant'
 * '<S30>'  : 'SCARA_215/predkosc_zadana_1/Compare To Constant1'
 * '<S31>'  : 'SCARA_215/predkosc_zadana_2/Compare To Constant'
 * '<S32>'  : 'SCARA_215/predkosc_zadana_2/Compare To Constant1'
 * '<S33>'  : 'SCARA_215/wspolczynniki/Compare To Zero'
 * '<S34>'  : 'SCARA_215/wspolczynniki/Compare To Zero1'
 */

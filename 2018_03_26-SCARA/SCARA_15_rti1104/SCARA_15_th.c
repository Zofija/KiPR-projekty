/************************ dSPACE target specific file *************************
   ...
   Include file .\SCARA_15_rti1104\SCARA_15_th.c :

   Task Configuration file for model : SCARA_15

   RTI1104 7.4 (02-May-2015)/2.10
   26-Mar-2018 08:19:51
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\SCARA_15_rti1104\SCARA_15_th.c is for ST).
# endif

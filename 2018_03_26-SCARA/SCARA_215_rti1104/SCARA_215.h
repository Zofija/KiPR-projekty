...
typedef struct {
  ...
  real_T SFunction1_h;                 /* '<S5>/S-Function1' */
  ...
  real_T SFunction2_j;                 /* '<S5>/S-Function2' */
  ...
  real_T DataStoreRead4;               /* '<Root>/Data Store Read4' */
  real_T DataStoreRead5;               /* '<Root>/Data Store Read5' */
  boolean_T DataStoreRead2;            /* '<Root>/Data Store Read2' */
  boolean_T SFunction;                 /* '<S1>/S-Function' */
  boolean_T LogicalOperator1;          /* '<Root>/Logical Operator1' */
  boolean_T Memory;                    /* '<S11>/Memory' */
  boolean_T Logic[2];                  /* '<S11>/Logic' */
  boolean_T Compare;                   /* '<S14>/Compare' */
  boolean_T Uk1;                       /* '<S9>/Delay Input1' */
  boolean_T FixPtRelationalOperator;   /* '<S9>/FixPt Relational Operator' */
  boolean_T DataStoreRead3;            /* '<Root>/Data Store Read3' */
  boolean_T SFunction_p;               /* '<S2>/S-Function' */
  boolean_T LogicalOperator3;          /* '<Root>/Logical Operator3' */
  boolean_T Memory_e;                  /* '<S12>/Memory' */
  boolean_T Logic_g[2];                /* '<S12>/Logic' */
} B_SCARA_215_T;
...
typedef struct {
  ZCSigState DS1104ENC_SET_POS_C2_Trig_ZCE;/* '<Root>/DS1104ENC_SET_POS_C2' */
...
struct P_SCARA_215_T_ {
  ...
  boolean_T Logic_table_o[16];         /* Computed Parameter: Logic_table_o
                                        ...
                                        */
  boolean_T DataStoreMemory2_InitialValue;/* Computed Parameter: DataStoreMemory2_InitialValue
 ...
 *
 * '<Root>' : 'SCARA_215'
 * '<S1>'   : 'SCARA_215/DS1104BIT_IN_C0'
 * '<S2>'   : 'SCARA_215/DS1104BIT_IN_C1'
 * '<S3>'   : 'SCARA_215/DS1104DAC_C1'
 * '<S4>'   : 'SCARA_215/DS1104DAC_C2'
 * '<S5>'   : 'SCARA_215/DS1104ENC_POS_C2'
 * '<S6>'   : 'SCARA_215/DS1104ENC_SETUP'
 * '<S7>'   : 'SCARA_215/DS1104ENC_SET_POS_C1'
 * '<S8>'   : 'SCARA_215/DS1104ENC_SET_POS_C2'
 * '<S9>'   : 'SCARA_215/Detect Fall Nonpositive'
 * '<S10>'  : 'SCARA_215/RTI Data'
 * '<S11>'  : 'SCARA_215/S-R Flip-Flop'
 * '<S12>'  : 'SCARA_215/S-R Flip-Flop1'
 * '<S13>'  : 'SCARA_215/_DS1104ENC_POS_C1'
 * '<S14>'  : 'SCARA_215/Detect Fall Nonpositive/Nonpositive'
 * '<S15>'  : 'SCARA_215/RTI Data/RTI Data Store'
 * '<S16>'  : 'SCARA_215/RTI Data/RTI Data Store/RTI Data Store'
 * '<S17>'  : 'SCARA_215/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 */
